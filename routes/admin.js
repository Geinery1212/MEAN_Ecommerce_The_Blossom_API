...
/*RUTAS PARA LA IMPLEMENTACIÓN DEL MODULO DE ADMINISTRADORES */
...
api.get('/obtener_admin_seleccionado/:id', auth.auth, AdminController.obtener_admin_seleccionado);
api.put('/actualizar_admin_seleccionado/:id', auth.auth, AdminController.actualizar_admin_seleccionado);
api.delete('/eliminar_admin_seleccionado/:id', auth.auth, AdminController.eliminar_admin_seleccionado);
api.put('/cambiar_pass_admin_seleccionado/:id', auth.auth, AdminController.cambiar_pass_admin_seleccionado);
/*CLIENTES */
api.put('/cambiar_pass_cliente_seleccionado/:id', auth.auth, AdminController.cambiar_pass_cliente_seleccionado);
api.get('/obtener_cliente_seleccionado/:id', auth.auth, AdminController.obtener_cliente_seleccionado);
api.delete('/eliminar_cliente_seleccionado/:id', auth.auth, AdminController.eliminar_cliente_seleccionado);
api.get('/obtener_catalogos', auth.auth, AdminController.obtener_catalogos );
api.post('/registro_catalogo_admin', auth.auth, AdminController.registro_catalogo_admin);
